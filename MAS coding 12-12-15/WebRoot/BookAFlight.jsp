										...
										<td>
											<div id="result">
												<form action="./GetFareDetails" name="bookaflight"
													...
													<table align="center" background="images/bgg2.jpg" width="500">
														<tr>
															<td align="left" colspan="2">
																<font size="4" face="verdana">Enter Your Journey
																	Details </font>
															</td>
														</tr>
														<tr>
														...
														<tr>
															<td colspan="2">
																<font color="gray" size="4">Select Your journey
																	Type</font> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; 
														...
														<tr>
															<td colspan=>
																<font color="gray" size="4">Date Of Journey:</font>
															 </td>
															 <td>
														...
														<tr>
															<td colspan=>
																<font color="gray" size="4">Date Of Return:</font>
